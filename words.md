...
## アシュアランスケース
システムやソフトウェアの品質に関する主張の正当性を裏づけるための文書であり、
その主張と根拠を論理的に説明することで、目標の品質を達成できることを示すために使用される。

## 垂直型プロトタイプ
システムの一部の機能を実際に操作できるまで開発したプロトタイプ。

## ウォークスルー
プログラマが主催し、複数の関係者が集まってソースプログラムを追跡し、プログラムの誤りを探す活動。

## マイクロサービスアーキテクチャ
各サービスが独立しているため、一つのサービスを変更することが容易。

## 判定条件網羅(分岐網羅)
各分岐の真と偽の両方を通るテストケースを設定する。

## システム適格性確認テスト
共通フレーム2013において、システム適格性確認テストで適合を評価する対象は、システム要件定義で
定義または設計した内容。

## システム開発プロセスおよびソフトウェア実装プロセス
保守プロセスの`修正の実施`アクティビティでは、ソフトウェア製品の修正テスト及びテストを実施するために、
システム開発プロセス及びソフトウェア実装プロセスを開始する。
